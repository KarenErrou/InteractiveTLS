...
myTLSApp.controller('TLSController', ['$scope', '$http', function($scope, $http){
	...
	$scope.keyExchange = [
 	...
 	$scope.clientHello = [
 		...
 		{eltType: 'opaque', delete: 'yes', adjustment:'no', eltName: 'legacy_session_id', eltValue: ';', 
 		...
 		{eltType: 'CipherSuite', delete: 'yes', adjustment:'yes', eltName: 'cipher_suites', eltValue: ';', 
 	...
 	$scope.serverHello = [
 		...
 		{eltType: 'opaque', delete: 'yes', adjustment:'yes', eltName: 'legacy_session_id', eltValue: ';', 
